...
const ME_BG = 'rgba(163,230,53,.06)';
    ...
    return (
        <div className="cc-root max-w-[1120px] mx-auto space-y-10">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <span className="cc-pill self-start md:self-auto" style={{ color: 'var(--cc-tx-2)' }}>
                    <HugeiconsIcon icon={Trophy} size={13} /> All-time XP standings
                </span>
            </header>
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm mt-1.5" style={{ color: 'var(--cc-tx-2)' }}>
                            {isUnranked
                                ? 'Solve a problem to earn XP and enter the standings.'
                                : <>Rank <span className="cc-mono font-semibold" style={{ color: 'var(--cc-tx-1)' }}>#{myRank ?? '—'}</span> · <span className="cc-mono font-semibold" style={{ color: 'var(--cc-tx-1)' }}>{formatXP(user?.xp ?? 0)}</span> XP</>}
                        </p>
                    </div>
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-bold" style={{ color: 'var(--cc-tx-1)' }}>Global standings</h2>
                ...
                <Surface elevation={1} className="overflow-hidden">
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        background: isMe ? ME_BG : 'transparent',
                                    }}
                                ...
                                >
                                    <span className="cc-mono text-sm w-8 text-center shrink-0" style={{ color: i < 3 ? (MEDAL_COLOR[i + 1] ?? 'var(--cc-tx-3)') : 'var(--cc-tx-3)' }}>{e.rank}</span>
                    ...
                    {/* Sticky "you" summary when not in the visible top list */}
