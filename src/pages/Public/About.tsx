    ...
    return (
        <div className="pt-32 pb-20 space-y-24">
            ...
            <section className="px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center text-center">
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-primary mb-8 max-w-4xl leading-tight animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 fill-mode-backwards">
                    Empowering the next generation of <span className="text-lime-500">Builders</span>.
                </h1>
                <p className="text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-backwards">
            ...
            <section className="px-6 md:px-12 max-w-7xl mx-auto">
                <div className="bg-primary text-white rounded-[3rem] p-12 md:p-24 relative overflow-hidden">
