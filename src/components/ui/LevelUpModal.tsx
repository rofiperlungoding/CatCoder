...
export const LevelUpModal: React.FC = () => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-[#1e1e1e] rounded-[3rem] shadow-2xl max-w-md w-full relative overflow-hidden animate-in zoom-in-95 duration-300 border border-white/60 dark:border-white/10">
                {/* Confetti Background Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-lime-50/50 via-white to-white opacity-50 dark:from-lime-900/10 dark:via-black/20 dark:to-black/20 pointer-events-none"></div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center p-10 pt-14">
                    ...
                    {/* Content */}
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Level Up!</h2>
                    <p className="text-muted-foreground dark:text-gray-400 mb-10 max-w-xs">
                        Congratulations! You've reached <span className="font-bold text-gray-900 dark:text-white">Level {levelUpModal.level}</span>. Keep coding to unlock more rewards.
                    </p>
                    ...
                    <div className="w-full bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-[2rem] p-5 mb-8 shadow-sm">
                        <div className="flex items-center gap-4 text-left">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground dark:text-gray-400">Access Tier {Math.min(5, Math.ceil(levelUpModal.level / 5))} problems</p>
                            </div>
                        </div>
                    </div>
